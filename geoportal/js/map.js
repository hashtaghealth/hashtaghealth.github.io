...
var withinRect = "SELECT AVG(calories) as a, AVG(percentalc) as b, AVG(percentexe) as c,AVG(percentfas) as d,AVG(percentfoo) as e,AVG(happy) as f,AVG(percenthea) as g,AVG(sentalc) as h,AVG(sentex) as i,AVG(sentfastfo) as j,AVG(sentfood) as k,AVG(senthealth) as l FROM public.{{table}} WHERE the_geom && ST_MakeEnvelope({{left}}, {{bottom}}, {{right}}, {{top}}, 4326)";
var withinCircle = "SELECT AVG(calories) as a, AVG(percentalc) as b, AVG(percentexe) as c,AVG(percentfas) as d,AVG(percentfoo) as e,AVG(happy) as f,AVG(percenthea) as g,AVG(sentalc) as h,AVG(sentex) as i,AVG(sentfastfo) as j,AVG(sentfood) as k,AVG(senthealth) as l FROM public.{{table}} WHERE ST_DWITHIN(the_geom, ST_SetSRID(ST_MakePoint({{lon}}, {{lat}}),4326)::geography,{{radius}})";
var withinPol = "SELECT AVG(calories) as a, AVG(percentalc) as b, AVG(percentexe) as c,AVG(percentfas) as d,AVG(percentfoo) as e,AVG(happy) as f,AVG(percenthea) as g,AVG(sentalc) as h,AVG(sentex) as i,AVG(sentfastfo) as j,AVG(sentfood) as k,AVG(senthealth) as l FROM public.{{table}} WHERE the_geom && ST_Transform(ST_GeomFromText('POLYGON(({{coordinates}}))',4326),4326)";
...
layers.push(new CartoDBLayer('tracts', 'Census Tract <a href="https://hashtaghealth.github.io/geoportal/data/tract.txt" target="_blank">(.txt /</a><a href="https://hashtaghealth.github.io/geoportal/data/tract.xlsx" target="_blank">.xlsx)</a>', 'https://hashtaghealth.carto.com/api/v2/viz/ca86b2d2-2160-11e7-90c0-0ee66e2c9693/viz.json', 'Map Layers'));
layers.push(new CartoDBLayer('zipsa', 'Zip code <a href="https://hashtaghealth.github.io/geoportal/data/zipcode.txt" target="_blank">(.txt /</a><a href="https://hashtaghealth.github.io/geoportal/data/zipcode.xls" target="_blank">.xls)</a>', 'https://hashtaghealth.carto.com/api/v2/viz/7392d940-2095-11e7-8c4c-0e233c30368f/viz.json', 'Map Layers'));
